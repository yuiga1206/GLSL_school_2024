...
/** ===========================================================================
 * GLSL（というよりもシェーダ）には、それ特有の癖と言いますか、独特な考え方みた
 * いなものが必要になることがあります。これが最初なかなかつかめないことも多く、
 * 初学者がつまづきやすい一因となっています。
 * ここでは、空間を複製する処理や、座標系を回転させる処理など、GLSL でよく用いら
 * れるテクニックを 2D ベースでフラグメントシェーダ上に実装してあります。
 * いずれも比較的単純な算数なので、落ち着いて図解するなどして考えてみましょう。
 * ========================================================================= */
