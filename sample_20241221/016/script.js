...
/** ===========================================================================
 * シェーダアートの世界で頻繁に登場するテクニックに「レイマーチング」があります。
 * 広義にレイマーチングと呼ばれているものは、より正確にはスフィアトレーシングと
 * 呼ばれる「レイトレーシング」の技法の一種です。
 * レイトレーシングやレイマーチングの世界では、ベクトルなどがたくさん登場します
 * ので、ある程度数学的な理解が深くないと、ちょっと扱うのが難しい場合が多いかも
 * しれません。
 * とはいえ、これまでに登場してきた数学の知識を応用すれば、実は意外にも理解する
 * ことはそれほど難しくないんじゃないかなと思います。
 * まずはこのサンプルを通じて、その基本原理を掴みましょう。
 * ========================================================================= */
